...
void PlaylistNode::SetNext(PlaylistNode* PlaylistNode) //Sets next Node
{
...
string PlaylistNode::GetSongName() const //Returns Song Name
{
    return songName ;
}

string PlaylistNode::GetArtistName() const //Returns Artist Name
{
    return artistName ;
}

int PlaylistNode::GetSongLength() const //Returns Song Length
{
    return songLength ;
}

PlaylistNode* PlaylistNode::GetNext() const //Returns Next Node
{
    return nextNodePtr ;
}
...
Playlist::Playlist() : head(nullptr), tail(nullptr){} //intializiation list for a new empty playlist
